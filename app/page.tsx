    ...
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="p-8 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 justify-center">
          ...
          <a href="/leagues/division-one-south-east" className="bg-blue-50 hover:bg-blue-100 transition rounded-xl shadow p-4 text-center">
            <h3 className="text-lg font-medium text-blue-800">Division One South East</h3>
            <p>Tier 4 – South East</p>
          </a>
          <a href="/leagues/division-one-south-west" className="bg-blue-50 hover:bg-blue-100 transition rounded-xl shadow p-4 text-center">
            <h3 className="text-lg font-medium text-blue-800">Division One South West</h3>
